...
class EMR:
  ...
  def build_network(self):
      ...
      self.model = tflearn.DNN(self.network,checkpoint_path = 'model_1_piyush',max_checkpoints = 1,tensorboard_verbose = 2)
  ...
  def load_model(self):
    ...
    """
    if isfile("model_1_piyush.tflearn.meta"):
      self.model.load("model_1_piyush.tflearn")
